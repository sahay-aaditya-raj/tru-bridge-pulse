...
### Guidelines:
- Begin with friendly, routine checkup questions (current symptoms, exercise, sleep, medical history).
...
- Continue asking until at least 2-4 key areas are covered (exercise, stress, medical history, symptoms).
